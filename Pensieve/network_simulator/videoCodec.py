# -*- coding: UTF-8 -*-
from rl.network_simulator.frame import Frame
import rl.network_simulator.project_root as project_root
import os
...
class VideoCodec(object):
    ...
    def read_frame_data(self, source_ip=None, destination_ip=None):
        """
        ...
        while len(self.frame_buffer) > 0:
            ...
            tmp_packets = frame.separate_frame_to_packet(self.udp_seq, source_ip, destination_ip)
